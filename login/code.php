	...
	<div class="row">
		<div class="col-lg-6 col-lg-offset-3">	
			...
			<div class="alert alert-success alert-dismissible" role="alert">
				...
				</button>We have a sent a security code to your email <span><?php
                    if (isset($_GET['email'])) {
                        echo $_GET['email'];
                    } else {
                        echo "no email given.";
								...
								<div class="col-lg-12">
									...
									<form id="register-form"  method="post" role="form" autocomplete="off">
										<div class="form-group">
											<input type="text" name="code" id="code" tabindex="1" class="form-control" placeholder="##########"
                                                   value="<?php echo $_GET['code'] ?? "" ?>" autocomplete="off" required/>
										</div>
										<div class="form-group">
											<div class="row">
